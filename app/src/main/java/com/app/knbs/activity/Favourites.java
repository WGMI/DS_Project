...
import com.app.knbs.fragments.Counties_Favourite_Fragment;
import com.app.knbs.fragments.National_Favourite_Fragment;
...
public class Favourites extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new National_Favourite_Fragment(), "National");
        adapter.addFragment(new Counties_Favourite_Fragment(), "County");
